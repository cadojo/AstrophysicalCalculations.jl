...
include(joinpath("paradigms", "stellar_observations.jl"))
include(joinpath("paradigms", "light_waves.jl"))
include(joinpath("paradigms", "special_relativity.jl"))
include(joinpath("paradigms", "light_matter_interactions.jl"))
